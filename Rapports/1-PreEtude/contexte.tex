...
%Introduction plus générale, dans le monde de l’informatique, pas que le projet, définitions associées (RV, interactions, immersion, domotique)FAIT
%Qqes éléments sur l’impact sociétal de l’aide à la personne FAIT
%Présentation sujet (fait le lien), partenariat INSA/Kerpape/(3è partenaire) ; mettre en avant le fait que demandeur extérieur FAIT
