...
\subsection{Données}
	...
	\begin{figure}[p]
		\centering
		\includegraphics[width=0.5\textwidth]{1-PreEtude/img/appart_unity}
		\caption{Modèle chargé dans Unity3d}
	\end{figure}
...
\subsection{Logiciels}
	...
	\subsubsection{3ds Max}
		\noindent\begin{minipage}{0.3\textwidth}
			...
			3ds Max\cite{3dsmax}, le modeleur 3D d'Autodesk, qui édite aussi Maya. 3ds Max est très implanté dans l'enseignement et l'industrie vidéoludique et filmographique.
			% le célèbre modeleur 3D d'Autodesk n'est plus à présenter; aujourd'hui encore considéré comme la référence en matière de modélisation 3D, et ce depuis plus de 10 ans, il est grandement utilisé dans l'industrie vidéoludique et filmographique.
	...
	\subsubsection{Unity}
		\noindent\begin{minipage}{0.3\textwidth}
			...
			Unity est actuellement utilisé dans la salle Immersia (cf. partie \ref{immersia}) de l'Irisa.
		\end{minipage}
