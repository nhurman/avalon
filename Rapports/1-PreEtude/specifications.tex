...
\subsection{Données}
	...
	%Unity dispose bien sur de fonctionnalitées d'import dans d'autres formats, mais Unity est connu pour être un peu capricieux (aka so mega casse-couilles) dans ses interractions avec les .max. 
...
\subsection{Logiciels}
	...
	%Rapport technique = serieux . On s'en fous si il est cool ou pas ton logiciel. A refaire...
