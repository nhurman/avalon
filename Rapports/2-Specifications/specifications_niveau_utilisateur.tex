...
Avec un type de vue exocentré, l’utilisateur contrôle un avatar à la 3ème personne ce qui ne l’immergera pas totalement dans la scène
\\
\textbf{Interface Souris - Clavier : }
L’utilisateur déplace son personnage à l’aide des touches du clavier. Il peut orienter la caméra l’aide de la souris. Pour entrer en interaction avec un objet il lui suffit de pointer l’objet avec la caméra et d’utiliser le clic gauche de la souris.
Dans cet interface on définit les boutons suivants :
	\begin{itemize}
				 ...
				 \item bouton de retour : touche escape du clavier
  				\item  bouton 2ème action : touche espace du clavier
			\end{itemize}
L’utilisateur pourra modifier ces réglages lui-même s’il souhaite inteagir avec des boutons différents.
\\
...
La salle Immersia est une salle d’environnment 3D qui permet à l’utilisateur de s’intégrer totalement dans l’environnement virtuel. Ici une ois muni des lunettes 3D, il pourra se déplacer totalement dans l’environnement.
