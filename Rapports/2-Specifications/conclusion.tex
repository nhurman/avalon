...
\begin{itemize}
  \item Version \textnumero1 - 9 décembre : Implémentation de l'appartement complet dans un environnement 3d. Le personnage peut se déplacer librement à l'intérieur, mais sans collisions avec l'environnement.
  ...
  \item Version \textnumero5 - 9 avril : La version finale fonctionne en réalité virtuelle dans ces 3 environnements : salle $\mu$RV, salle Immersia, casque de réalité virtuelle.
\end{itemize}
