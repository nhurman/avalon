...
\markright{Avalon - Bilan de planification}
\author{
...
\input{8-BilanPlanification/planification_initiale.tex}
\pagebreak
\input{8-BilanPlanification/evolution.tex}
\pagebreak
\input{8-BilanPlanification/organisation.tex}
